...
def do_test(board, K, __expected):
    ...
    exception = None
    try:
        __result = instance.getMinimum(board, K);
    except:
        import traceback
...
def run_tests():
    sys.stdout.write("DropCoins (600 Points)\n\n")
    ...
    with open("DropCoins.sample", "r") as f:
        while True:
            label = f.readline()
